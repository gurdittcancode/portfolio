...
export default function Hero() {
    ...
    return (
        <div
            className={`w-10/12 md:w-4/5 max-w-[750px] flex-col items-center border-b-4 border- border-b-cyan-500 border-dotted pb-8 transition-all duration-700   ${
                visible
        ...
        >
                ...
                <div className="flex">
                    <div className="w-full lg:w-1/2 flex flex-col gap-y-3">
                        ...
                        <span className="text-gray-500 font-semibold text-xl">
                            rearranging 0s and 1s to create beautiful,
                            minimalist websites and products for the last 1.5
                            years. here to serve your web development needs
                        </span>
                        <span className="font-semibold text-xl text-white mt-3">
                            actively looking for internships and full-time roles
                            as a full-stack engineer
                        </span>
                        <span className="text-gray-500 text-xl mt-3">
                            hire me{" "}
                            <CircleArrowRight className="inline-block mr-2" />
            ...
            <div className="text-lg font-semibold mt-6">
                in my coding journey, i have interned at both small startups and
                big tech companies, and i won a category prize in{" "}
                <a
                ...
                in my first semester of college. i was also a core team member
                at
                <a
                    href="https://mlsacbvp.vercel.app/"
                    className="text-cyan-500"
                >
                    {" "}
                    MLSAC-BVP
